...
class StimInterfaceWidget(QWidget):
    ...
    def create_stimulation_controls(self):
        ...
        self.activate_button.clicked.connect(self.stimulateur_com.activate_stimulateur(self))
        ...
        self.stop_button.clicked.connect(self.stimulateur_com.stop_stimulateur(self))
